...
class HomeChangeLog(Home):
    ...
    def index(self, *args_, **kwargs_):
        try:
            ...
            changes = _('Could not load changes from the repo. [Click here for CHANGES.md]({changes_url})').format(changes_url='https://sickrage.github.io/sickrage-news/CHANGES.md')
